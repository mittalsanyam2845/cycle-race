...
var oppYellow1Img,oppYvarellow2Img;
...
mainCyclist.addAnimation("SahilRunning",mainRacerImg1);
   mainCyclist.addAnimation("Sahil_Running",mainRacerImg2);
...
gameOver.scale=0.4;
  ...
  mainCyclist.setCollider("rectangle",0,0,70,150);
...
function draw() {
  ...
  if (World.frameCount % 50 == 0) {
   ...
   if(pinkCG.isTouching(mainCyclist)){
    ...
    mainCyclist.changeAnimation("Sahil_Running",mainRacerImg2);
